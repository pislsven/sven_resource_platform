  ...
  var a = layui.jquery,
    ...
    P = {
      ...
      sendAuthCode: function(e) {
        e = a.extend(
          { seconds: 60, elemPhone: '#LAY_phone', elemVercode: '#LAY_vercode' },
          e
        )
        var i,
          t = e.seconds,
          ...
          l = function(a) {
            t--,
              t < 0
                ? (n.removeClass(f).html('获取验证码'),
                  (t = e.seconds),
                  clearInterval(i))
                : n.addClass(f).html(t + '秒后重获'),
              a ||
      ...
      sideFlexible: function(e) {
        ...
        'spread' === e
          ...
          : (t.removeClass(g).addClass(x),
            ...
            i.removeClass(v)),
          layui.event.call(this, n.MOD_NAME, 'side({*})', { status: e })
      },
      popup: l.popup,
      popupRight: function(e) {
        return (P.popup.index = layer.open(
          a.extend(
            {
              type: 1,
              id: 'LAY_adminPopupR',
      ...
      initTheme: function(e) {
        var a = n.theme
        ;(e = e || 0),
          a.color[e] && ((a.color[e].index = e), P.theme({ color: a.color[e] }))
      },
      tabsPage: {},
      tabsBody: function(e) {
        return a(m)
      ...
      resize: function(e) {
        ...
        P.resizeFn[i] && (r.off('resize', P.resizeFn[i]), delete P.resizeFn[i]),
          'off' !== e &&
            (e(), (P.resizeFn[i] = e), r.on('resize', P.resizeFn[i]))
      },
      resizeFn: {},
      runResize: function() {
        var e = layui.router(),
    ...
    F = (P.events = {
      ...
      fullscreen: function(e) {
        var a = 'layui-icon-screen-full',
          ...
          t = e.children('i')
        t.hasClass(a)
          ? (P.fullScreen(), t.addClass(i).removeClass(a))
          : (P.exitScreen(), t.addClass(a).removeClass(i))
      },
      about: function() {
        P.popupRight({
      ...
      closeOtherTabs: function(e) {
        ...
        'all' === e
          ...
          : (a(z).each(function(e, t) {
              e &&
                e != P.tabsPage.index &&
                (a(t).addClass(i), P.tabsBody(e).addClass(i))
            }),
            a('.' + i).remove())
      },
  ...
  !(function() {
    ...
    t.on('nav(layadmin-system-side-menu)', function(e) {
      e.siblings('.layui-nav-child')[0] &&
        u.hasClass(C) &&
        (P.sideFlexible('spread'), layer.close(e.data('index'))),
        (P.tabsPage.type = 'nav')
    }),
